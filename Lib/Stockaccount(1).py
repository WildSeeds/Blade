...
def modifyOp():
    ...
    a=addwin.getelementbyattribute('tag name:input,ref:ztree_vc_branch_id_edit')
    a.Click()
...
def login():
    ...
    addwin.getelementbyattribute(r'xpath:/html/body/descendant::label[@title="部门编号"]/following-sibling::*/descendant::*/input[last()]').sendkeys("webui")
    addwin.getelementbyattribute(r'xpath:descendant::label[@title="用户别名"]/following-sibling::*/descendant::*/input[last()]').sendkeys("webui")
    addwin.getelementbyattribute(r'xpath:descendant::label[@title="电话号码"]/following-sibling::*/descendant::*/input[last()]').sendkeys("webui")
    addwin.getelementbyattribute(r'xpath:descendant::label[@title="手机号码"]/following-sibling::*/descendant::*/input[last()]').sendkeys("webui")
    addwin.getelementbyattribute(r'xpath:descendant::label[@title="联系地址"]/following-sibling::*/descendant::*/input[last()]').sendkeys("webui")
    addwin.getelementbyattribute(r'xpath:descendant::label[@title="电子邮件"]/following-sibling::*/descendant::*/input[last()]').sendkeys("webui")
    addwin.getelementbyattribute(r'xpath:descendant::label[@title="身份证号"]/following-sibling::*/descendant::*/input[last()]').sendkeys("webui")
    addwin.getelementbyattribute(r'xpath:descendant::label[@title="其他信息"]/following-sibling::*/descendant::*/input[last()]').sendkeys("webui")
    time.sleep(10)
    addwin.getelementbyattribute('tag name:button,text:取消').Click()
    clicktable(0)
    #driver.close()
